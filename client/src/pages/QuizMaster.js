            ...
            {questions.map((round, i) => (
              <div key={`round-${i}`}>
                {round.map((question, j) => (
                  <Question key={`question-${j}`} question={question} stateValues={this.state.inputState}
...
function Question(props) {
  ...
  return (
    <div>
      <TextField fullWidth required type="number" id={roundId} label="Runde" defaultValue={round}
                 disabled/>
      <TextField fullWidth required type="number" id={positionInRoundId} label="Position in Runde"
                 defaultValue={positionInround} disabled/>
      <TextField fullWidth required id={questionId} label="Frage" value={getStateValue(stateValues, questionId)}
                 onChange={onChangeHandler}/>
      <TextField fullWidth id={questionExternalLinkId} label="Externer Link"
                 value={getStateValue(stateValues, questionExternalLinkId)}
                 onChange={onChangeHandler}/>
      <TextField fullWidth id={correctAnswerId} label="Korrekte Antwort"
