    ...
    return (
        <div>
            ...
            <div>
                ...
                <button disabled={locked} onClick={() => add_partner(partnerID)}>Add a partner</button>
            </div>
            <div>
                <input disabled={locked} value={messageContent} onChange={(e) => setMessageContent(e.target.value)}/>
                <button disabled={locked} onClick={() => connect_send(messageContent)}>Send Message</button>
            </div>
